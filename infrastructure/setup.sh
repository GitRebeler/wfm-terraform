...
curl -o /etc/nca/bootstrap-azure.sh https://shddevuse01sa01.blob.core.windows.net/global-package-repos-use1/terraform/user_data/os_base/azure/bootstrap-azure.sh
